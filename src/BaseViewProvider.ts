...
export class BaseViewProvider implements vscode.WebviewViewProvider {
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		...
		const styleMainUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'dist/compiled', 'style.css'))
		...
		return `
			...
			<html lang="en">
				<head>
					...
					<meta http-equiv="Content-Security-Policy" content="style-src 'self' https://*.vscode-cdn.net https://cdn.jsdelivr.net 'unsafe-inline'">
