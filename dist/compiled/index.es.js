...
const toDisplayString$1 = (val) => {
  return isString$3(val) ? val : val == null ? "" : isArray$3(val) || isObject$4(val) && (val.toString === objectToString$2 || !isFunction$3(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
axios.default = axios;
var axios$1 = axios;
var _style_0 = ".amn-details[data-v-69d559f0]{display:flex;align-items:center}\n";
  ...
  if (options._setup) {
    ...
    options.setup = function setup(props, ctx) {
      ...
      const {
        props: _props,
        provideSubDefaults
      } = internalUseDefaults(props, (_a2 = props._as) != null ? _a2 : options.name, defaults2);
...
function internalUseDefaults() {
  ...
  const componentDefaults = computed(() => {
    var _a2, _b;
    return (_b = defaults2.value) == null ? void 0 : _b[(_a2 = props._as) != null ? _a2 : name];
  });
...
const _hoisted_1 = { class: "amn-details" };
  ...
  setup(__props) {
    ...
    const fetchamnList = async () => {
      try {
        ...
        amnList.value = response.data.results.map((amn, index) => ({
          id: index + 1,
          name: amn.name,
          url: amn.url,
        ...
        await Promise.all(
          amnList.value.map(async (amn) => {
            const spriteResponse = await axios$1.get(amn.url);
            amn.sprite = spriteResponse.data.sprites.front_default;
          })
        );
      } catch (error) {
        console.error("Fehler beim Abrufen der Pok\xE9mon-Liste", error);
      }
    };
    function addAMN() {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createVNode(VExpansionPanels, null, {
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(amnList.value, (amn) => {
              return openBlock(), createBlock(VExpansionPanel, {
                ...
                default: withCtx(() => [
                    ...
                    default: withCtx(() => [
                      createBaseVNode("div", _hoisted_1, [
                        createBaseVNode("img", {
                          src: amn.sprite,
                          alt: "amn Image",
                          style: { "width": "32px", "height": "32px", "margin-right": "10px", "display": "flex" }
                        }, null, 8, _hoisted_2),
                        createBaseVNode("p", _hoisted_3, toDisplayString$1(amn.name), 1)
                      ])
                    ]),
                    _: 2
                  }, 1024),
                  createVNode(VExpansionPanelText, null, {
                    default: withCtx(() => [
                      createBaseVNode("p", null, toDisplayString$1(amn.description), 1),
                      createBaseVNode("div", _hoisted_4, [
                        createTextVNode(" Add " + toDisplayString$1(amn.name) + " to Modeler ", 1),
                        createVNode(VIcon, {
                          color: "warning",
                          icon: "mdi-plus",
                          onClick: addAMN
...
var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]], ["__scopeId", "data-v-69d559f0"]]);
/*!
  * shared v9.2.2
...
function createRtl(i18n2, options) {
  ...
  const isRtl = computed(() => {
    var _a2;
    return (_a2 = rtl.value[i18n2.current.value]) != null ? _a2 : false;
  });
  return {
    isRtl,
    rtl,
